...
START_DETECTOR_PARAMS = [ Param::FLAG200, Param::FLAG302, Param::MSG, Param::TPORTS, Param::FOLLOWDIRECTION ]
...
class Detector
  ...
  FLAG200, FLAG302, MSG, TPORTS, FDIRECTION = START_DETECTOR_PARAMS
  ...
  def initialize _ = Detector.create_flagmethod, __ = load_tables
